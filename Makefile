.PHONY register-cyberdyne:
register-cyberdyne:
	curl -X DELETE http://localhost:3000/registrations
	curl -X POST -H 'Content-Type: application/json' -d '{"url": "http://localhost:3001/target", "event": "customer_created"}' http://localhost:3000/registrations
